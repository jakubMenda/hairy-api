export default (date: string, sender: string, logoUrl: string) => {
                                                                                    ...
                                                                                    <td>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable'
                                                                                                ...
                                                                                                <br>
                                                                                                <p>Dobrý den. Vaše objednávka na datum <b>${date}</b> byla zrušena. Pokud k tomu došlo bez Vaší vůle, doporučujeme kontaktovat salón.</p>
                                                                                                <br><br>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
