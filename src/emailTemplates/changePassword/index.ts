export default (password: string, sender: string, logoUrl: string) => {
                                                                                        ...
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable'
                                                                                                ...
                                                                                                <h2 style="font-size: 20px;">
                                                                                                    Obnovení hesla</h2>
                                                                                                <br>
                                                                                                <p>Posíláme Vám Vaše nové heslo. Kvůli bezpečnosti ho doporučujeme po prvním přihlášení změnit v nastavení Vašeho profilu.</p>
                                                                                                <br><br>
                                                                                                <div
                                                                                                   class='link3'
                                                                                                   style='color:#555555;'>${password}</div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
