export default (firstName: string, lastName: string, email: string, phone: string, date: string, sender: string, logoUrl: string) => {
                                                                                        ...
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable'
                                                                                                ...
                                                                                                <h2 style="font-size: 20px;">
                                                                                                    Evidujeme u Vás novou objednávku</h2>
                                                                                                <br>
                                                                                                <p>Ve Vašem kalendáři byla zaregistrována nová objednávka!</p>
                                                                                                <br><br>
                                                                                                <p><b>Datum:</b> ${date}</p>
